	...
	<div class="card">
		<form action="<?=base_url('admin/caraousel/simpan');?>" method="post" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="mb-3">
					<label for="formFile" class="form-label">Foto dengan ukuran 1:3</label>
...
<div class="col-md-6 col-lg-4 mb-3 mt-4">
	<div class="card h-100">
		<img class="card-img-top" src="<?= base_url('assets/upload/caraousel/'.$a['foto'])?>" alt="Card image cap">
		<div class="card-body">
			<h5 class="card-title"><?= $a['judul'] ;?></h5>
			<a class="btn btn-danger" onClick="return confirm('Apakah anda yakin ingin hapus data ini?')"
						href="<?=base_url('admin/caraousel/delete/'.$a['foto'])?>">
