...
<body>
	<div class="body-inner">
		...
		<!--/ Header end -->
		<div id="banner-area" class="banner-area" style="background-color:orange;">
			<div class="banner-text">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="banner-heading">
								<h1 class="banner-title"><?=$konten->nama_kategori?></h1>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb justify-content-center">
										<li class="breadcrumb-item"><a href="<?=base_url()?>">Home</a></li>
										<li class="breadcrumb-item"><a href="#"><?=$konten->nama_kategori?></a></li>
								...
								<div class="entry-header">
									...
									<div class="post-meta">
										<span class="post-author">
											<p class="mr-1"><i class="far fa-user"></i><?=$konten->username?></p>
										</span>
										<span class="post-cat">
											<p class="mr-1"><i
													class="far fa-folder-open"></i><?=$konten->nama_kategori?></p>
										</span>
										<span class="post-meta-date"><i
												class="far fa-calendar"></i><?=$konten->tanggal?></span>
									</div>
									<div class="post-media post-image">
										<img loading="lazy" src="<?= base_url('assets/upload/konten/'.$konten->foto)?>"
						...
						<div class="sidebar sidebar-right">
                                ...
                                <?php foreach($recent as $r) {?>
									<li class="d-flex align-items-center">
										<div class="posts-thumb">
											<img loading="lazy" alt="img" src="<?= base_url('assets/upload/konten/'.$r['foto'])?>">
										</div>
										<div class="post-info">
											<h4 class="entry-title">
												<a href="<?= base_url('home/artikel/'.$r['slug'])?>"><?=$r['judul']?></a>
											</h4>
										</div>
									</li>
                                <?php } ?>
							...
							<div class="widget">
								...
								<ul class="arrow nav nav-tabs">
									...
									<?php foreach ($kategori as $kateg){?>
									<li>
										<a href="<?= base_url('home/kategori/'.$kateg['id_kategori'])?>"
