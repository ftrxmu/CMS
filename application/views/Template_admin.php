...
>
  <head>
    ...
    <script src="https://cdn.tiny.cloud/1/hxydqazj7dxey9j57jfu1ltbso72xrgft7kq5cbeu4dye40j/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
  </head>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <?php if( $this->session->userdata('level') =='Admin' ){?>
            <li class="menu-item <?php if($menu=='gallery'){ echo 'active'; } ?>">
            ...
            <?php } ?>
            <?php if( $this->session->userdata('level') =='Admin' ){?>
            <li class="menu-item <?php if($menu=='feedback'){ echo 'active'; } ?>">
              <a href="<?=site_url('admin/feedback')?>" class="menu-link">
